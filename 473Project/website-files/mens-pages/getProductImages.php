<?php
     ...
     if($data->num_rows > 0){
         while($data2 = $data->fetch_assoc()){
            $imageLink1 = $data2['imageLink1'];
            $imageLink2 = $data2['imageLink2'];
            $imageLink3 = $data2['imageLink3'];
            $imageLink4 = $data2['imageLink4'];
            $imageLink5 = $data2['imageLink5'];
            $imageLink6 = $data2['imageLink6'];
        }
     }
